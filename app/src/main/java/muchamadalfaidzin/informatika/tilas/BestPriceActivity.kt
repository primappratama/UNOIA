...
class BestPriceActivity : AppCompatActivity() {

    private lateinit var rvbestprice: RecyclerView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvbestprice= findViewById(R.id.rvbestprice)
        ...
        rvbestprice.layoutManager = GridLayoutManager(this, 2)
        rvbestprice.adapter = adapter
